          ...
          <div className="analytics-grid">
              ...
              {incomeData.length === 0 ? (
                ...
                <div className="chart-container">
                  <ResponsiveContainer width="100%" height={200}>
                    <BarChart data={incomeData} layout="vertical" margin={{ top: 0, right: 16, left: 0, bottom: 0 }}>
            ...
            <div className="glass-card">
              ...
              {expenseData.length === 0 ? (
                ...
                <div className="chart-container">
                  <ResponsiveContainer width="100%" height={200}>
                    <BarChart data={expenseData} layout="vertical" margin={{ top: 0, right: 16, left: 0, bottom: 0 }}>
                      <CartesianGrid strokeDasharray="3 3" stroke="rgba(255,255,255,0.06)" horizontal={false} />
                      <XAxis
                        type="number"
                        tick={{ fill: 'rgba(246,239,232,0.45)', fontSize: 11 }}
